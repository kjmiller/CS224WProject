...
def train(training_data_list, p_warm_start_list, p_grad_warm_start_list, params, cost_fun, grad_fun, w0, pool = None):
	print(w0.shape)
	w_opt = scipy.optimize.fmin_bfgs(cost_fun, w0, fprime = grad_fun, args = (training_data_list, p_warm_start_list, p_grad_warm_start_list, params, pool), maxiter=params["maxiter"], retall = RETALL, callback = CALLBACK_FUN)
	print(w_opt)
...
w0 = 1e-6 * numpy.random.randn(training_data_list[0]["num_features"], 1)
print(w0.shape)
